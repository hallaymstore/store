...
const demoProducts = [
	...
	{ title:'Apple AirPods Pro 2', slug:'airpods-pro-2', price:3200000, oldPrice:3800000, image:'https://picsum.photos/seed/airpods2/600/600', rating:4.7, reviews:512, category:'electronics', description:'Aktiv shovqinni yo\'qotish texnologiyasi, Transparency rejimi, USB-C zaryadlash.' },
	{ title:'Nike Air Max 270 Erkaklar uchun', slug:'nike-air-max-270', price:1450000, oldPrice:1900000, image:'https://picsum.photos/seed/nike270/600/600', rating:4.5, reviews:189, category:'fashion', description:'Qulay va zamonaviy sport krossovka. Havo yostiqi texnologiyasi bilan.' },
	{ title:'Xiaomi Robot Changyutgich S10+', slug:'xiaomi-robot-vacuum', price:4800000, oldPrice:5500000, image:'https://picsum.photos/seed/vacuum1/600/600', rating:4.6, reviews:78, category:'home', description:'Aqlli uy uchun robot changyutgich. LDS navigatsiya, 4000Pa so\'rish kuchi.' },
	{ title:'Erkaklar uchun klassik ko\'ylak', slug:'classic-shirt', price:350000, oldPrice:null, image:'https://picsum.photos/seed/shirt1/600/600', rating:4.3, reviews:94, category:'fashion', description:'100% paxta, nafis dizayn, ofis va kundalik kiyim uchun ideal.' },
	{ title:'MacBook Air M2 15-dyum', slug:'macbook-air-m2-15', price:19500000, oldPrice:22000000, image:'https://picsum.photos/seed/macbook2/600/600', rating:4.9, reviews:156, category:'electronics', description:'Apple M2 chip, 8GB RAM, 256GB SSD, 15.3 dyum Liquid Retina displey.' },
	{ title:'Tefal Multikuker RK8121', slug:'tefal-multicooker', price:1200000, oldPrice:1500000, image:'https://picsum.photos/seed/cooker1/600/600', rating:4.4, reviews:231, category:'home', description:'45 ta avtomatik dastur, 5L sig\'im, taymer, issiqlikni saqlash.' },
	{ title:'Adidas Ultraboost 23', slug:'adidas-ultraboost-23', price:1850000, oldPrice:null, image:'https://picsum.photos/seed/adidas1/600/600', rating:4.6, reviews:67, category:'fashion', description:'Boost texnologiyasi, Continental kauchuk taglik, Primeknit yuza.' },
	{ title:'Samsung 55" QLED 4K Smart TV', slug:'samsung-55-qled', price:8900000, oldPrice:11000000, image:'https://picsum.photos/seed/tv1/600/600', rating:4.7, reviews:98, category:'electronics', description:'Quantum Dot texnologiyasi, 4K UHD, Smart Hub, HDR10+ qo\'llab-quvvatlash.' },
	{ title:'Dyson V15 simsiz changyutgich', slug:'dyson-v15', price:7500000, oldPrice:8200000, image:'https://picsum.photos/seed/dyson1/600/600', rating:4.8, reviews:44, category:'home', description:'Lazer yoritgich texnologiyasi, 60 daqiqali batareya, HEPA filtrlash.' },
	{ title:'Zara ayollar uchun palto', slug:'zara-coat', price:890000, oldPrice:1200000, image:'https://picsum.photos/seed/coat1/600/600', rating:4.2, reviews:156, category:'fashion', description:'Zamonaviy dizayn, issiq material, kuz-qish mavsumi uchun ideal.' },
	{ title:'JBL Charge 5 Bluetooth kolonka', slug:'jbl-charge-5', price:1100000, oldPrice:1350000, image:'https://picsum.photos/seed/jbl1/600/600', rating:4.5, reviews:287, category:'electronics', description:'IP67 suv o\'tkazmaydigan, 20 soat batareya, Powerbank funksiyasi.' },
	{ title:'Philips Hava tozalagich AC1217', slug:'philips-air', price:3400000, oldPrice:null, image:'https://picsum.photos/seed/philips1/600/600', rating:4.3, reviews:52, category:'home', description:'HEPA filtri, 63m² gacha xona uchun, tungi rejim, sifat sensori.' },
	{ title:'Levi\'s 501 Original jins shim', slug:'levis-501', price:750000, oldPrice:950000, image:'https://picsum.photos/seed/levis1/600/600', rating:4.6, reviews:324, category:'fashion', description:'Klassik to\'g\'ri kesim, 100% paxta denim, vaqt o\'tishi bilan go\'zal eskirish.' },
	{ title:'iPad Air M1 10.9"', slug:'ipad-air-m1', price:9200000, oldPrice:10500000, image:'https://picsum.photos/seed/ipad1/600/600', rating:4.8, reviews:178, category:'electronics', description:'Apple M1 chip, 10.9" Liquid Retina, Apple Pencil 2 qo\'llab-quvvatlash.' },
	{ title:'De\'Longhi kofe mashinasi', slug:'delonghi-coffee', price:5600000, oldPrice:6800000, image:'https://picsum.photos/seed/coffee1/600/600', rating:4.7, reviews:89, category:'home', description:'Avtomatik espresso, cappuccino, latte. Ichki maydalagich, 1.8L suv idishi.' }
];
...
app.get('/api/products', async (req, res) => {
  try {
	...
	if (dbConnected) {
		...
		let filtered = global.demoProductsCached.slice();
	...
	return res.json({ total: global.demoProductsCached.length, page: 1, limit: 12, products: global.demoProductsCached.slice(0, 12) });
  }
});
